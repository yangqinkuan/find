...
public class RedisUtil {
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            logger.info(ErrorEnum.REDISUTILL_ERROR.getDescription() + ":" + e.getMessage());
            return false;
        }
        return false;
    }
     ...
     * @return true 存在 false不存在
     */
    public boolean hashExistedKey(String key, String item) {
